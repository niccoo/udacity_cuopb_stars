...
class Block {
    ...
    validate() {
        ...
        return new Promise((resolve, reject) => {
            ...
            if(currentHash === recalculatedHash){
                ...
                console.log("Error - Block invalid");
                resolve(false)
            }
        });
    }
    ...
    getBData() {
        ...
        return new Promise((resolve, reject) => {
            ...
            let decodedData = hex2ascii(encodedData) //Buffer.from(encodedData, 'hex').toString()
            ...
            if(self.previousBlockHash){
                ...
                reject(Error("Genesis Block - No data to return!"));
            }
        })
    }
...
let b = new Block([1,2,3])

console.log("Validation");

b.validate().then(function(result) {
...
b.getBData().then(function(result) {
    console.log("Success!", result);
  }).catch(function(error) {
    console.log("Failed!", error);
  })
